...
You can find the backup file for the database in this repo (Bovelo_Database.sql). The schema name is 'bovelo', just create it and use the backup in the "Import data" section. 
